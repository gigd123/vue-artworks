<template>
  <div class="wrap" id="todolist">
    ...
    <div class="active-status">
      <ul>
        <li>
          <a href="#" :class="{'active-li' : visibility === 'all'}" @click="visibility = 'all'">All</a>
        </li>
        <li>
          <a
            href="#"
            :class="{'active-li' : visibility === 'active'}"
        ...
        <li>
          <a
            href="#"
            :class="{'active-li' : visibility === 'completed'}"
    ...
    <ul class="lists">
      <li v-for="(item, key) in filterTodo" :key="key" @dblclick="editTodo(item)">
        ...
        <div class="edit-group" v-if="item.id === catchTodo.id">
          ...
          />
          <button class="btn" @click="saveTodo(item)">Save</button>
          <button class="btn" @click="cancelTodo()">Cancel</button>
        </div>
      </li>
    </ul>
    <div class="footer">
      <div class="footer-remind">
        Sill have
        <span>{{todoCount}}</span> case need to complete
      </div>
      <div class="footer-delete-all">
        <button class="btn" @click="removeAll()">Delete all</button>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    addTodo () {
      ...
      let newNumber = Math.floor(new Date())
      if (!value) {
        return
      }
      this.todos.push({
